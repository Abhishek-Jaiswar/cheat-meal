            ...
            <body>
              <div class="email-container">
                ...
                <div class="email-body">
                  ...
                  <p>We are excited to have you on board at cheatmeal. Explore our platform and enjoy our services.</p>
                  <p>If you have any questions or need assistance, feel free to reach out to us.</p>
                  <p>Best Regards,<br/>The cheatmeal Team</p>
                </div>
                <div class="email-footer">
                  <p>&copy; 2024 cheatmeal. All rights reserved.</p>
                </div>
              </div>
            </body>
          </html>
        ...
        <body>
          <div class="email-container">
            ...
            <div class="email-body">
              ...
              <p>Thank you,<br/>The cheatmeal Team</p>
            </div>
            <div class="email-footer">
              <p>&copy; 2024 cheatmeal. All rights reserved.</p>
            </div>
        ...
        <body>
          <div class="email-container">
            ...
            <div class="email-body">
              ...
              <p>Thank you,<br/>The cheatmean Team</p>
            </div>
            <div class="email-footer">
              <p>&copy; 2024 cheatmeal. All rights reserved.</p>
            </div>
